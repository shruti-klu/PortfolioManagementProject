        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    com.portfolioproject.app.MutualFund stock = new com.portfolioproject.app.MutualFund(
                            stockId,
                            stockName,
                            purchasePrice,
                            currentPrice
                    ...
                    ((User) stockUser).addHolding(stockHolding);
                ...
                case 3:
                    ...
                    sc.nextLine();
                    com.portfolioproject.app.MutualFund mutualFund = new com.portfolioproject.app.MutualFund(mfPurchasePrice,nav,mfQuantity);
                ...
                case 5:
                    ...
                    for (User user : users) {
                        ...
                        if (user.getHoldings().isEmpty()) {
                            ...
                            for (User holding : user.getHoldings()) {
